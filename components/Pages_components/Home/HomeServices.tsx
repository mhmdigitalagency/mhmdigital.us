      ...
      <div className="px-4 xl:px-14 xxl:px-40 xll:px-80 xxx:px-[22%] lll:px-[25%]">
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-red-500 font-bold uppercase tracking-wider text-sm">Our Services</p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {MAIN_SERVICES.map((service) => (
            <article
              key={service.slug}
              className="group rounded-3xl border border-gray-200 bg-white p-6 hover:shadow-lg hover:border-red-100 transition-all"
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  {service.startingPrice && (
                    <p className="text-sm text-red-500 font-semibold mt-0.5">{service.startingPrice}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <Link
                  ...
                  className="text-sm font-semibold text-red-500 hover:underline inline-flex items-center gap-1"
                ...
                <Link
                  href="/quote"
                  className="text-sm font-semibold text-gray-700 hover:text-red-500 ml-auto"
                >
                  Request a Quote
                </Link>
              </div>
