          ...
          {deals.map((deal) => (
            ...
            >
              {deal.imageUrl ? (
                ...
                <div className="aspect-16/10 bg-linear-to-br from-brand/5 to-white flex items-center justify-center">
              ...
              <div className="p-6">
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  {deal.badgeText && (
                    <span className="rounded-full bg-brand px-3 py-1 text-xs font-bold text-white uppercase tracking-wide">
                      {deal.badgeText}
                    </span>
                  )}
                  {deal.discountLabel && (
                ...
                <Link
                  href={deal.buttonUrl}
                  className="inline-flex items-center gap-2 text-sm font-semibold text-brand-blue group-hover:gap-3 transition-all"
                >
