            ...
            <div className='flex items-center justify-between px-4 xl:px-14 py-8 xxl:px-40 xll:px-80 xxx:px-[22%] lll:px-[25%]'>
                  <div className='w-55'> 
                        <Link className='flex items-center gap-1' href={'/'}>
                              ...
                              <span className='text-red-500 font-bold text-lg xs:text-[22px] md:text-[28px]'>MHM</span><span className='font-semibold text-lg xs:text-[22px] md:text-[28px]'>Digital</span>
                        </Link>
                  </div>
                  <NavNormal />
